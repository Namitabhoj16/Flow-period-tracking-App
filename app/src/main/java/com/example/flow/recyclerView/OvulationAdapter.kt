...
class OvulationAdapter(private val dataSet: MutableList<DetailedArticles> = mutableListOf()) :
    RecyclerView.Adapter<OvulationAdapter.OvulationViewHolder>() {
    private var context: Context? = null

    class OvulationViewHolder(containerView: View) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OvulationViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.artical_card_view, parent, false)
        context = parent.context
        return OvulationViewHolder(view)
    }

    override fun onBindViewHolder(holder: OvulationViewHolder, position: Int) {
