...
class DischargeAdapter(private val dataSet: MutableList<DetailedArticles> = mutableListOf()) :
    RecyclerView.Adapter<DischargeAdapter.DischargeViewHolder>() {
    private var context: Context? = null

    class DischargeViewHolder(containerView: View) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DischargeViewHolder {
        ...
        return DischargeViewHolder(view)
    }
